...
Au début je ne comprenais pas le lien entre les nombres de Catalan et Pi, c'est à dire entre la première et la deuxième équation. Ce lien semble issu de la [formule de Stirling](https://fr.wikipedia.org/wiki/Formule_de_Stirling), qui "permet de calculer un équivalent asymptotique de la suite des nombres de Catalan". Quand n est grand, la seconde équation est donc équivalente à l'équation qui permet de calculer la suite des nombres de Catalan mais cette dernière a le bon goût de faire appel à Pi. Comme on peut s'y attendre, ChatGPT a bien lu et digéré tout Wikipédia !
